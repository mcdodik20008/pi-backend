...
public class UserExcelExporter {
    ...
    private void writeDataLines() {
        ...
        for (var user : listUsers) {
            ...
            var cellCount = 0;
            createCell(row, cellCount++, user.getLogin(), style);
            createCell(row, cellCount++, user.getFirstName(), style);
            createCell(row, cellCount++, user.getSecondName(), style);
            createCell(row, cellCount, user.getLastName(), style);
